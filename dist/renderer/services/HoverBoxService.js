...
var _CHoverBoxService_instances, _CHoverBoxService_showHoverBox, _CHoverBoxService_hideHoverBox;
    ...
    attach(alias, element, content, options) {
        const subscriber = {
            ...
            callbacks: {
                ...
                hide: (e) => {
                    __classPrivateFieldGet(this, _CHoverBoxService_instances, "m", _CHoverBoxService_hideHoverBox).call(this, subscriber, e);
...
}, _CHoverBoxService_hideHoverBox = function _CHoverBoxService_hideHoverBox(subscriber, e) {
